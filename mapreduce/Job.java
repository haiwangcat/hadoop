...
public class Job extends JobContext {  
 ...
 static public boolean run(Configuration conf, String name, Class<?> c1, Class<? extends Mapper> c2, Class<? extends Reducer> c3, Class<? extends Reducer> c4, Class<?> c5, Class<?> c6, Path input, Path output) throws IOException, InterruptedException, ClassNotFoundException
  {
      ...
      while (!success)
      {
          ...
          job.setJarByClass(c1);
          job.setMapperClass(c2);
          job.setCombinerClass(c3);
          job.setReducerClass(c4);
          job.setOutputKeyClass(c5);
          job.setOutputValueClass(c6);
          success = job.waitForCompletion(true);

          System.out.println(">>>>>>>>>>>> New Job:" + job.getJobID());
